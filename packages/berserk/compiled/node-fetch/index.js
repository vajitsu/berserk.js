  ...
  var e = {
    ...
    473: (e, p, a) => {
      ...
      function DBCSCodec(e, p) {
        ...
        if (e.encodeAdd) {
          for (var _ in e.encodeAdd)
            if (Object.prototype.hasOwnProperty.call(e.encodeAdd, _))
              this._setEncodeChar(_.charCodeAt(0), e.encodeAdd[_])
        }
        this.defCharSB =
          ...
          if (typeof i === 'string') {
            for (var m = 0; m < i.length; ) {
              ...
              if (55296 <= t && t < 56320) {
                ...
                if (56320 <= s && s < 57344)
                  a[p++] = 65536 + (t - 55296) * 1024 + (s - 56320)
                else
                  throw new Error(
      ...
      DBCSEncoder.prototype.write = function (e) {
        var p = d.alloc(e.length * (this.gb18030 ? 4 : 3)),
          a = this.leadSurrogate,
          m = this.seqObj,
          t = -1,
          s = 0,
          o = 0
      ...
      DBCSDecoder.prototype.write = function (e) {
        var p = d.alloc(e.length * 2),
          a = this.nodeIdx,
          s = this.prevBytes,
          r = this.prevBytes.length,
        ...
        for (var c = 0, u = 0; c < e.length; c++) {
          ...
          if (n >= 0) {
            ...
            if (c >= 3) {
              ...
              var f =
                (s[c - 3 + r] - 129) * 12600 +
                ((c - 2 >= 0 ? e[c - 2] : s[c - 2 + r]) - 48) * 1260 +
                ((c - 1 >= 0 ? e[c - 1] : s[c - 1 + r]) - 129) * 10 +
                (v - 48)
            }
        ...
        this.prevBytes =
          o >= 0
            ? Array.prototype.slice.call(e, o)
            : s.slice(o + r).concat(Array.prototype.slice.call(e))
    ...
    421: (e, p, a) => {
      ...
      for (var i = 0; i < d.length; i++) {
        var m = d[i]
        for (var l in m)
          if (Object.prototype.hasOwnProperty.call(m, l)) p[l] = m[l]
      }
    },
    494: (e, p, a) => {
      var d = a(983).Buffer
    ...
    138: (e, p, a) => {
      ...
      SBCSEncoder.prototype.write = function (e) {
        ...
        for (var a = 0; a < e.length; a++)
          p[a] = this.encodeBuf[e.charCodeAt(a)]
        return p
      }
    ...
    527: (e, p, a) => {
      ...
      Utf16Decoder.prototype.write = function (e) {
        if (!this.decoder) {
          ...
          var a = ''
          for (var d = 0; d < this.initialBufs.length; d++)
            a += this.decoder.write(this.initialBufs[d])
      ...
      Utf16Decoder.prototype.end = function () {
        if (!this.decoder) {
          ...
          var p = ''
          for (var a = 0; a < this.initialBufs.length; a++)
            p += this.decoder.write(this.initialBufs[a])
    ...
    451: (e, p, a) => {
      ...
      p.utf32le = { type: '_utf32', isLE: true }
      p.utf32be = { type: '_utf32', isLE: false }
      p.ucs4le = 'utf32le'
      p.ucs4be = 'utf32be'
        ...
        for (var l = 0; l < p.length; l += 2) {
          ...
          if (this.highSurrogate) {
            if (s || !r) {
              ...
              var o =
                (((this.highSurrogate - 55296) << 10) | (t - 56320)) + 65536
              i.call(a, o, m)
              m += 4
              this.highSurrogate = 0
              continue
    ...
    516: (e, p, a) => {
      ...
      Utf7Decoder.prototype.end = function () {
        ...
        if (this.inBase64 && this.base64Accum.length > 0)
          e = this.iconv.decode(d.from(this.base64Accum, 'base64'), 'utf16-be')
        this.inBase64 = false
        this.base64Accum = ''
        return e
      }
          ...
          if (!i) {
            ...
            if (!n[e[l]]) {
              if (l == a && e[l] == r) {
                ...
                var t =
                  m +
                  this.iconv.decode(e.slice(a, l), 'ascii').replace(/,/g, '/')
    ...
    254: (e, p, a) => {
      ...
      m.encode = function encode(e, p, a) {
        ...
        var l = i.write(e)
        var t = i.end()
        return t && t.length > 0 ? d.concat([l, t]) : l
      }
      ...
      m.getCodec = function getCodec(e) {
        if (!m.encodings) m.encodings = a(421)
    ...
    178: (e, p, a) => {
      ...
      e.exports = function (e) {
        ...
        IconvLiteDecoderStream.prototype._transform = function (e, p, a) {
          if (!d.isBuffer(e) && !(e instanceof Uint8Array))
            return a(
    ...
    983: (e, p, a) => {
      ...
      if (!m.constants) {
        m.constants = { MAX_LENGTH: m.kMaxLength }
        if (m.kStringMaxLength) {
    ...
    700: (e, p, a) => {
      ...
      function validateLabel(e, p) {
        ...
        for (var l = 0; l < i; ++l) {
          ...
          if (
            (processing === m.TRANSITIONAL && s[1] !== 'valid') ||
      ...
      function processing(e, p, a) {
        ...
        return { string: i.join('.'), error: d.error }
      }
    ...
    429: (e, p, a) => {
      ...
      p.implementation = class URLImpl {
        constructor(e) {
          ...
          const m = d.basicURLParse(p, { baseURL: i })
          if (m === 'failure') {
    ...
    11: (e, p, a) => {
      ...
      function parseHost(e, p) {
        ...
        const d = i.toASCII(
          a,
          false,
          i.PROCESSING_OPTIONS.NONTRANSITIONAL,
          false
        )
        if (d === null) {
          return l
          ...
          if (isNaN(e)) {
            ...
            if (
              ...
              (this.input.length - this.pointer - 1 >= 2 &&
                !r.has(this.input[this.pointer + 2]))
            ) {
              this.url.host = this.base.host
              this.url.path = this.base.path.slice()
