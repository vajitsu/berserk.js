;(() => {
  var e = {
    93: (e) => {
      ...
      const i = 7
      const r = 256
      const s = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9]
      let n
      const log10 = (e) =>
        e < 1e5
          ? e < 100
          ...
          ? e < 1e8
            ...
            : 8
          : 9
      function alphabeticalCompare(e, t) {
        if (e === t) {
          return 0
        }
        if (~~e === e && ~~t === t) {
      ...
      function binaryInsertionSort(e, t, i, r, s) {
        if (r === t) {
          r++
        }
        for (; r < i; r++) {
      ...
      function gallopLeft(e, t, i, r, s, n) {
        let a = 0
        let o = 0
        let u = 1
        if (n(e, t[i + s]) > 0) {
          o = r - s
          while (u < o && n(e, t[i + s + u]) > 0) {
            a = u
            u = (u << 1) + 1
            if (u <= 0) {
              u = o
      ...
      function gallopRight(e, t, i, r, s, n) {
        let a = 0
        let o = 0
        let u = 1
        if (n(e, t[i + s]) < 0) {
      ...
      class TimSort {
        constructor(e, t) {
          ...
          this.length = s
          this.minGallop = i
          this.tmpStorageLength = s < 2 * r ? s >>> 1 : r
        ...
        mergeRuns() {
          while (this.stackSize > 1) {
            ...
            if (
              (e >= 1 &&
                this.runLength[e - 1] <=
                  this.runLength[e] + this.runLength[e + 1]) ||
              (e >= 2 &&
                this.runLength[e - 2] <=
                  this.runLength[e] + this.runLength[e - 1])
            ) {
              if (this.runLength[e - 1] < this.runLength[e + 1]) {
                e--
              }
        ...
        forceMergeRuns() {
          while (this.stackSize > 1) {
            let e = this.stackSize - 2
            if (e > 0 && this.runLength[e - 1] < this.runLength[e + 1]) {
              e--
            }
            this.mergeAt(e)
          }
        ...
        mergeAt(e) {
          ...
          const { array: i } = this
          let r = this.runStart[e]
          let s = this.runLength[e]
          const n = this.runStart[e + 1]
          let a = this.runLength[e + 1]
          this.runLength[e] = s + a
          if (e === this.stackSize - 3) {
            this.runStart[e + 1] = this.runStart[e + 2]
            this.runLength[e + 1] = this.runLength[e + 2]
          }
          this.stackSize--
          const o = gallopRight(i[n], i, r, s, 0, t)
          r += o
          s -= o
          if (s === 0) {
            return
          }
          a = gallopLeft(i[r + s - 1], i, n, a, a - 1, t)
          if (a === 0) {
            return
          }
          if (s <= a) {
            this.mergeLow(r, s, n, a)
          } else {
            this.mergeHigh(r, s, n, a)
          }
        }
        mergeLow(e, t, r, s) {
        ...
        mergeHigh(e, t, r, s) {
          ...
          while (true) {
            ...
            do {
              r = t - gallopRight(u[p], o, e, t, t - 1, a)
              if (r !== 0) {
                f -= r
                l -= r
                t -= r
              ...
              D = s - gallopLeft(o[l], u, 0, s, s - 1, a)
              if (D !== 0) {
                f -= D
                p -= D
                s -= D
      ...
      function sort(e, i, r, s) {
        ...
        let h = 0
        if (u < t) {
          h = makeAscendingRun(e, r, s, i)
          binaryInsertionSort(e, r, s, r + h, i)
          return n
        }
        const c = new TimSort(e, i)
        const l = minRunLength(u)
        do {
          h = makeAscendingRun(e, r, s, i)
          if (h < l) {
            let t = u
            ...
            binaryInsertionSort(e, r, r + t, r + h, i)
            h = t
          }
          c.pushRun(r, h)
          c.mergeRuns()
    ...
    637: (e, t, i) => {
      ...
      const move_comments = (e, t, i, r, s, n) => {
        ...
        while (a < r) {
          const r = a++
          move_comment(e, t, i + r, s, n)
        }
      }
      const remove_comments = (e, t) => {
        n.forEach((i) => {
          const r = o(i, t)
          delete e[r]
        })
      }
      const get_mapped = (e, t) => {
        let i = t
        while (i in e) {
          i = e[i]
        }
      ...
      class CommentArray extends Array {
        ...
        concat(...e) {
          ...
          move_comments(i, this, 0, this.length, 0)
          e.forEach((e) => {
            const s = t
            t += r(e) ? e.length : 1
            ...
            move_comments(i, e, 0, e.length, s)
          })
          return i
        }
        sort(...e) {
          const t = s(this, ...e.slice(0, 1))
          const i = Object.create(null)
          t.forEach((e, t) => {
            if (e === t) {
              return
            }
            const r = get_mapped(i, e)
            if (r === t) {
              return
            }
            i[t] = r
      ...
      e.exports = { CommentArray: CommentArray }
    },
    584: (e, t, i) => {
      const r = i(277)
      const { isObject: s, isArray: n, isString: a, isNumber: o } = i(642)
      const u = 'before'
      const h = 'after-prop'
      const c = 'after-colon'
      const l = 'after-value'
      ...
      const C = '-'
      const S = [u, h, c, l, p]
      const A = [u, f, d].map(Symbol.for)
      const g = ':'
      const F = undefined
      const symbol = (e, t) => Symbol.for(e + g + t)
      const define = (e, t, i) =>
      ...
      const copy_comments_by_kind = (e, t, i, s, n, a) => {
        const o = symbol(n, s)
        if (!r(t, o)) {
          return
        }
      ...
      const copy_comments = (e, t, i, r, s) => {
        S.forEach((n) => {
          copy_comments_by_kind(e, t, i, r, n, s)
        })
      }
      const swap_comments = (e, t, i) => {
        ...
        S.forEach((s) => {
          const n = symbol(s, i)
          if (!r(e, n)) {
            copy_comments_by_kind(e, e, i, t, s, true)
            return
          }
          const a = e[n]
          delete e[n]
          copy_comments_by_kind(e, e, i, t, s, true)
          define(e, symbol(s, t), a)
        })
      }
      const assign_non_prop_comments = (e, t) => {
        A.forEach((i) => {
          const r = t[i]
          if (r) {
            define(e, i, r)
      ...
      e.exports = {
        ...
        PREFIX_BEFORE: u,
        PREFIX_AFTER_PROP: h,
        PREFIX_AFTER_COLON: c,
        PREFIX_AFTER_VALUE: l,
        PREFIX_AFTER: p,
        PREFIX_BEFORE_ALL: f,
        PREFIX_AFTER_ALL: d,
        BRACKET_OPEN: m,
        BRACKET_CLOSE: x,
        CURLY_BRACKET_OPEN: D,
        CURLY_BRACKET_CLOSE: E,
        COLON: g,
        COMMA: v,
        MINUS: C,
        EMPTY: y,
        ...
        assign_non_prop_comments: assign_non_prop_comments,
        assign(e, t, i) {
          if (!s(e)) {
    ...
    376: (e, t, i) => {
      const { parse: r, tokenize: s } = i(504)
      const n = i(633)
      const { CommentArray: a } = i(637)
      const { assign: o } = i(584)
      e.exports = {
        parse: r,
        stringify: n,
        tokenize: s,
    ...
    504: (e, t, i) => {
      ...
      const symbolFor = (e) => Symbol.for(w !== y ? e + x + w : e)
      const transform = (e, t) => (M ? M(e, t) : t)
      const unexpected = () => {
        const e = new SyntaxError(`Unexpected token ${N.value.slice(0, 1)}`)
        Object.assign(e, N.loc.start)
        throw e
      }
      const unexpected_end = () => {
        const e = new SyntaxError('Unexpected end of JSON input')
        Object.assign(e, P ? P.loc.end : { line: 1, column: 0 })
        throw e
      }
      const next = () => {
        const e = T[++I]
        B = (N && e && N.loc.end.line === e.loc.start.line) || false
        P = N
        N = e
      }
      const type = () => {
        ...
        return N.type === 'Punctuator' ? N.value : N.type
      }
      const is = (e) => type() === e
      const expect = (e) => {
        if (!is(e)) {
      ...
      const parse_comments = (e) => {
        const t = []
        while (N && (is('LineComment') || is('BlockComment'))) {
          const e = { ...N, inline: B }
          t.push(e)
          next()
        }
      ...
      e.exports = { parse: parse, tokenize: tokenize }
    },
    633: (e, t, i) => {
      const {
        isArray: r,
      ...
      const join_content = (e, t, i) => {
        const r = process_comments(t, c, i + T, true)
        return join(r, e, i)
      }
      const array_stringify = (e, t) => {
        ...
        for (let t = 0; t < r; t++) {
          ...
          n = process_comments(e, AFTER(t), i)
        }
        s += join(n, process_comments(e, d, i), i)
        return x + join_content(s, e, t) + D
      }
      ...
      function stringify(e, t, i) {
        ...
        switch (typeof a) {
          case 'string':
            return quote(a)
          case 'number':
            return Number.isFinite(a) ? String(a) : w
          case 'boolean':
          case 'null':
            return String(a)
          case 'object':
      ...
      const get_indent = (e) => (o(e) ? e : a(e) ? u(F, e) : S)
      const { toString: P } = Object.prototype
      const N = ['[object Number]', '[object String]', '[object Boolean]']
      ...
      e.exports = (e, t, i) => {
        ...
        clean()
        return s(e)
          ? process_comments(e, h, S).trimLeft() +
              o +
              process_comments(e, m, S).trimRight()
          : o
      }
    },
    642: (e, t, i) => {
      ...
      t.isBuffer = i(300).Buffer.isBuffer
