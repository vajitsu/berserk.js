  ...
  var t = {
    ...
    847: (t, e, r) => {
      ...
      function expand(t, e) {
        ...
        if (!s) return [t]
        var n = s.pre
        var o = s.post.length ? expand(s.post, false) : ['']
        if (/\$$/.test(s.pre)) {
          ...
          var h = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(s.body)
          var u = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(s.body)
          var p = h || u
          var v = s.body.indexOf(',') >= 0
          if (!p && !v) {
            if (s.post.match(/,.*\}/)) {
          ...
          if (p) {
            var g = numeric(d[0])
            var y = numeric(d[1])
            var _ = Math.max(d[0].length, d[1].length)
            var w = d.length == 3 ? Math.abs(numeric(d[2])) : 1
            var k = lte
            var E = y < g
            if (E) {
              w *= -1
            ...
            var S = d.some(isPadded)
            b = []
            for (var O = g; k(O, y); O += w) {
              var A
              if (u) {
                ...
                if (S) {
                  var x = _ - A.length
                  if (x > 0) {
                    var G = new Array(x + 1).join('0')
                    if (O < 0) A = '-' + G + A.slice(1)
                    else A = G + A
                  }
                }
              }
            ...
            for (var j = 0; j < d.length; j++) {
              b.push.apply(b, expand(d[j], false))
            }
          }
    ...
    623: (t, e, r) => {
      ...
      e.realpathSync = function realpathSync(t, e) {
        ...
        while (h < t.length) {
          ...
          if (e && Object.prototype.hasOwnProperty.call(e, p)) {
            ...
            var y = null
            if (!s) {
              var _ = g.dev.toString(32) + ':' + g.ino.toString(32)
      ...
      e.realpath = function realpath(t, e, r) {
        ...
        function gotStat(t, i) {
          ...
          if (!s) {
            var a = i.dev.toString(32) + ':' + i.ino.toString(32)
            if (o.hasOwnProperty(a)) {
              return gotTarget(null, o[a], v)
            }
          }
          n.stat(v, function (t) {
            if (t) return r(t)
    ...
    945: (t, e, r) => {
      ...
      function setopts(t, e, r) {
        ...
        t.changedCwd = false
        var n = process.cwd()
        if (!ownProp(r, 'cwd')) t.cwd = s.resolve(n)
        else {
          t.cwd = s.resolve(r.cwd)
          t.changedCwd = t.cwd !== n
        }
        t.root = r.root || s.resolve(t.cwd, '/')
        t.root = s.resolve(t.root)
        t.cwdAbs = a(t.cwd) ? t.cwd : makeAbs(t, t.cwd)
        t.nomount = !!r.nomount
        if (process.platform === 'win32') {
          t.root = t.root.replace(/\\/g, '/')
          t.cwd = t.cwd.replace(/\\/g, '/')
          t.cwdAbs = t.cwdAbs.replace(/\\/g, '/')
        }
        r.nonegate = true
        r.nocomment = true
        r.allowWindowsEscape = true
      ...
      function finish(t) {
        ...
        for (var i = 0, s = t.matches.length; i < s; i++) {
          var n = t.matches[i]
    ...
    529: (t, e, r) => {
      ...
      glob.sync = u
      var k = (glob.GlobSync = u.GlobSync)
      glob.glob = glob
      function extend(t, e) {
      ...
      glob.hasMagic = function (t, e) {
        ...
        r.noprocess = true
        var i = new Glob(t, r)
        var s = i.minimatch.set
        if (!t) return false
        if (s.length > 1) return true
        for (var n = 0; n < s[0].length; n++) {
          if (typeof s[0][n] !== 'string') return true
        }
        return false
      }
      glob.Glob = Glob
      ...
      Glob.prototype._realpathSet = function (t, e) {
        ...
        s.forEach(function (r, s) {
          r = n._makeAbs(r)
          i.realpath(r, n.realpathCache, function (i, s) {
            if (!i) o[s] = true
      ...
      Glob.prototype._process = function (t, e, r, i) {
        ...
        if (p) this._processGlobStar(a, c, u, o, e, r, i)
        else this._processReaddir(a, c, u, o, e, r, i)
      }
      Glob.prototype._processReaddir = function (t, e, r, i, s, n, a) {
        var o = this
        this._readdir(r, n, function (c, l) {
          return o._processReaddir2(t, e, r, i, s, n, l, a)
        })
      }
      Glob.prototype._processReaddir2 = function (t, e, r, i, s, n, a, o) {
        if (!a) return o()
        var l = i[0]
        ...
        if (i.length === 1 && !this.mark && !this.stat) {
          if (!this.matches[s]) this.matches[s] = Object.create(null)
          for (var d = 0; d < y; d++) {
            var b = v[d]
            if (t) {
              if (t !== '/') b = t + '/' + b
            ...
            if (b.charAt(0) === '/' && !this.nomount) {
              b = c.join(this.root, b)
            }
            this._emitMatch(s, b)
          }
          return o()
        ...
        for (var d = 0; d < y; d++) {
          ...
          this._process([b].concat(i), s, n, o)
        }
        o()
      }
      ...
      Glob.prototype._readdirInGlobStar = function (t, e) {
        ...
        var s = b(r, lstatcb_)
        if (s) i.fs.lstat(t, s)
        function lstatcb_(r, s) {
          if (r && r.code === 'ENOENT') return e()
          var n = s && s.isSymbolicLink()
          i.symlinks[t] = n
          if (!n && s && !s.isDirectory()) {
            i.cache[t] = 'FILE'
            e()
      ...
      Glob.prototype._readdir = function (t, e, r) {
        ...
        var s = this
        s.fs.readdir(t, readdirCb(this, t, r))
      }
      function readdirCb(t, e, r) {
        return function (i, s) {
          if (i) t._readdirError(e, i, r)
          else t._readdirEntries(e, s, r)
        }
      }
      ...
      Glob.prototype._readdirError = function (t, e, r) {
        ...
        switch (e.code) {
          ...
          case 'ENOTDIR':
            ...
            this.cache[i] = 'FILE'
            if (i === this.cwdAbs) {
              var s = new Error(e.code + ' invalid cwd ' + this.cwd)
              s.path = this.cwd
              s.code = e.code
              this.emit('error', s)
              this.abort()
      ...
      Glob.prototype._processGlobStar = function (t, e, r, i, s, n, a) {
        var o = this
        this._readdir(r, n, function (c, l) {
          o._processGlobStar2(t, e, r, i, s, n, l, a)
        })
      }
      Glob.prototype._processGlobStar2 = function (t, e, r, i, s, n, a, o) {
        if (!a) return o()
        var c = i.slice(1)
        var l = t ? [t] : []
        var h = l.concat(c)
        this._process(h, s, false, o)
        ...
        for (var v = 0; v < p; v++) {
          ...
          var b = l.concat(a[v], c)
          this._process(b, s, true, o)
          var g = l.concat(a[v], i)
          this._process(g, s, true, o)
        }
        o()
      }
      Glob.prototype._processSimple = function (t, e, r) {
        var i = this
        this._stat(t, function (s, n) {
          i._processSimple2(t, e, s, n, r)
        })
      }
      Glob.prototype._processSimple2 = function (t, e, r, i, s) {
        if (!this.matches[e]) this.matches[e] = Object.create(null)
        if (!i) return s()
        if (t && h(t) && !this.nomount) {
          var n = /[\/\\]$/.test(t)
          if (t.charAt(0) === '/') {
            t = c.join(this.root, t)
          } else {
      ...
      Glob.prototype._stat = function (t, e) {
        ...
        if (a !== undefined) {
          if (a === false) return e(null, a)
            ...
            if (i && o === 'FILE') return e()
            else return e(null, o, a)
          }
        }
        var c = this
        ...
        function lstatcb_(i, s) {
          if (s && s.isSymbolicLink()) {
            return c.fs.stat(r, function (i, n) {
              if (i) c._stat2(t, r, null, s, e)
      ...
      Glob.prototype._stat2 = function (t, e, r, i, s) {
        ...
        if (e.slice(-1) === '/' && i && !i.isDirectory())
          return s(null, false, i)
        var a = true
        if (i) a = i.isDirectory() ? 'DIR' : 'FILE'
        this.cache[e] = this.cache[e] || a
        if (n && a === 'FILE') return s()
        return s(null, a, i)
      }
    },
    407: (t, e, r) => {
      ...
      GlobSync.prototype._finish = function () {
        ...
        if (this.realpath) {
          ...
          this.matches.forEach(function (e, r) {
            var s = (t.matches[r] = Object.create(null))
            for (var n in e) {
              try {
                n = t._makeAbs(n)
                var a = i.realpathSync(n, t.realpathCache)
                s[a] = true
              } catch (e) {
                if (e.syscall === 'stat') s[t._makeAbs(n)] = true
                else throw e
              }
            }
          })
      ...
      GlobSync.prototype._process = function (t, e, r) {
        ...
        if (d(this, o)) return
        var u = a[0] === s.GLOBSTAR
        if (u) this._processGlobStar(n, o, c, a, e, r)
        else this._processReaddir(n, o, c, a, e, r)
      }
      GlobSync.prototype._processReaddir = function (t, e, r, i, s, n) {
        var a = this._readdir(r, n)
        if (!a) return
        var o = i[0]
        var l = !!this.minimatch.negate
        var h = o._glob
        var u = this.dot || h.charAt(0) === '.'
        var p = []
      ...
      GlobSync.prototype._processGlobStar = function (t, e, r, i, s, n) {
        var a = this._readdir(r, n)
        if (!a) return
        var o = i.slice(1)
        var c = t ? [t] : []
        var l = c.concat(o)
        this._process(l, s, false)
        var h = a.length
        var u = this.symlinks[r]
        if (u && n) return
        for (var p = 0; p < h; p++) {
          ...
          var d = c.concat(a[p], o)
          this._process(d, s, true)
          var b = c.concat(a[p], i)
          this._process(b, s, true)
        }
      }
    ...
    373: (t, e, r) => {
      ...
      i.defaults = (t) => {
        ...
        const e = i
        const m = (r, i, s) => e(r, i, ext(t, s))
        m.Minimatch = class Minimatch extends e.Minimatch {
          constructor(e, r) {
            super(e, ext(t, r))
          }
        }
        m.Minimatch.defaults = (r) => e.defaults(ext(t, r)).Minimatch
        m.filter = (r, i) => e.filter(r, ext(t, i))
        m.defaults = (r) => e.defaults(ext(t, r))
        m.makeRe = (r, i) => e.makeRe(r, ext(t, i))
        m.braceExpand = (r, i) => e.braceExpand(r, ext(t, i))
        m.match = (r, i, s) => e.match(r, i, ext(t, s))
        return m
      }
      i.braceExpand = (t, e) => braceExpand(t, e)
      ...
      const g = Symbol('subparse')
      i.makeRe = (t, e) => new Minimatch(t, e || {}).makeRe()
      i.match = (t, e, r = {}) => {
        const i = new Minimatch(e, r)
      ...
      const globUnescape = (t) => t.replace(/\\(.)/g, '$1')
      ...
      class Minimatch {
        constructor(t, e) {
          ...
          this.windowsPathsNoEscape =
            !!e.windowsPathsNoEscape || e.allowWindowsEscape === false
        ...
        matchOne(t, e, r) {
          ...
          for (
            var s = 0, a = 0, o = t.length, c = e.length;
            s < o && a < c;
            s++, a++
          ) {
            ...
            if (typeof l === 'string') {
              d = h === l
              this.debug('string match', l, h, d)
            } else {
              d = h.match(l)
              this.debug('pattern match', l, h, d)
            }
            if (!d) return false
          }
          if (s === o && a === c) {
        ...
        parse(t, e) {
          ...
          const clearStateChar = () => {
            if (d) {
              ...
              this.debug('clearStateChar %j %j', d, i)
              d = false
            }
          }
          for (let e = 0, n; e < t.length && (n = t.charAt(e)); e++) {
            this.debug('%s\t%s %s %j', t, e, i, n)
            if (a) {
              if (n === '/') {
                return false
              }
            ...
            switch (n) {
              ...
              case '@':
              case '!':
                this.debug('%s\t%s %s %j <-- stateChar', t, e, i, n)
                if (b) {
                  this.debug('  in class')
                  if (n === '!' && e === _ + 1) n = '^'
                  i += n
                ...
                this.debug('call clearStateChar %j', d)
                clearStateChar()
                d = n
          ...
          for (k = h.pop(); k; k = h.pop()) {
            let t
            t = i.slice(k.reStart + k.open.length)
            this.debug('setting tail', i, k)
            t = t.replace(/((?:\\{2}){0,64})(\\?)\|/g, (t, e, r) => {
              if (!r) {
                r = '\\'
              }
              return e + e + r + '|'
            ...
            this.debug('tail=%j\n   %s', t, t, k, i)
            const e = k.type === '*' ? l : k.type === '?' ? c : '\\' + k.type
            s = true
            i = i.slice(0, k.reStart) + e + '\\(' + t
          }
          clearStateChar()
          if (a) {
            i += '\\\\'
          }
          const O = v[i.charAt(0)]
          for (let t = u.length - 1; t > -1; t--) {
            const r = u[t]
            const s = i.slice(0, r.reStart)
            const n = i.slice(r.reStart, r.reEnd - 8)
            let a = i.slice(r.reEnd)
            const o = i.slice(r.reEnd - 8, r.reEnd) + a
            const c = s.split('(').length - 1
            let l = a
            for (let t = 0; t < c; t++) {
              l = l.replace(/\)[+*?]?/, '')
            }
          ...
          const A = r.nocase ? 'i' : ''
          try {
            return Object.assign(new RegExp('^' + i + '$', A), {
              _glob: t,
              _src: i,
            })
          } catch (t) {
        ...
        makeRe() {
          ...
          const e = this.options
          const r = e.noglobstar ? l : e.dot ? h : u
          const i = e.nocase ? 'i' : ''
          let s = t
            .map((t) => {
              t = t
                .map((t) =>
                  typeof t === 'string' ? regExpEscape(t) : t === n ? n : t._src
                )
                .reduce((t, e) => {
                  if (!(t[t.length - 1] === n && e === n)) {
                    t.push(e)
                  }
                  return t
                }, [])
