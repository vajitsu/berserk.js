;(() => {
  var __webpack_modules__ = {
    ...
    8795: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      const { Collection } = __nccwpck_require__(2676)
      const { makeURLSearchParams } = __nccwpck_require__(1372)
      const { OAuth2Scopes, Routes } = __nccwpck_require__(2)
      ...
      const { Sticker } = __nccwpck_require__(2736)
    ...
    8485: (e) => {
      e.exports = require('berserk/dist/compiled/@sapphire/shapeshift')
    },
    4030: (e) => {
      e.exports = require('berserk/dist/compiled/undici')
    },
    9230: (e) => {
      e.exports = require('berserk/dist/compiled/ws')
    },
    2254: (e) => {
