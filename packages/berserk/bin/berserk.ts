...
if (args['--version']) {
  console.log(`Berserk.js v${process.env.__BERSERK_VERSION}`)
  process.exit(0)
}

const foundCommand = Boolean(commands[args._[0]])

// Makes sure the `berserk --help` case is covered
// This help message is only showed for `berserk --help`
// `berserk <subcommand> --help` falls through to be handled later
