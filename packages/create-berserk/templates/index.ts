...
/**
 * Get the file path for a given file in a template, e.g. "berserk.config.js".
 */
...
export const installTemplate = async ({
   ...
   */
  const dependencies = ['discord.js', 'berserk']
  /**
   ...
   */
  /*if (eslint) {
    dependencies.push('eslint', 'eslint-config-berserk')
  }/*
