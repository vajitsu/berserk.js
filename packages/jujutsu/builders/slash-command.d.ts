...
declare function data({ nameLocalizations, description, descriptionLocalizations, defaultMemberPermissions, dmPermission, subcommandGroups, subcommands, }: SlashCommandData): Discord.SlashCommandBuilder;
declare abstract class SlashCommand {
    ...
    abstract run(interaction: Discord.ChatInputCommandInteraction, bot: Discord.Client<true>, id?: string, unhookInteraction?: () => void): Promise<void>;
    calculatePermissions(interaction: Discord.ChatInputCommandInteraction): Discord.PermissionResolvable;
    protected requireUserPemission(permission: Discord.PermissionResolvable, member: Discord.GuildMember, interaction: Discord.ChatInputCommandInteraction): void;
}
