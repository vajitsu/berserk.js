;(() => {
  var e = {
    ...
    798: (e, r, t) => {
      class Range {
        ...
        parseRange(e) {
          ...
          return e
            ...
            .filter(this.options.loose ? (e) => !!e.match(n) : () => true)
      ...
      const replaceTildes = (e, r) =>
        e
          .trim()
          .split(/\s+/)
          .map((e) => replaceTilde(e, r))
          .join(' ')
      ...
      const replaceCarets = (e, r) =>
        e
          .trim()
          .split(/\s+/)
          .map((e) => replaceCaret(e, r))
          .join(' ')
    ...
    654: (e, r, t) => {
      ...
      const simpleSubset = (e, r, t) => {
        if (e.length === 1 && e[0].semver === o)
          return r.length === 1 && r[0].semver === o
        const s = new Set()
        let a, l
        for (const r of e) {
        ...
        if (a && l) {
          ...
          if (c > 0) return null
          else if (c === 0 && (a.operator !== '>=' || l.operator !== '<='))
            return null
        }
        for (const e of s) {
        ...
        for (const e of r) {
          ...
          if (a) {
            if (e.operator === '>' || e.operator === '>=') {
              p = higherGT(a, e, t)
              if (p === e) return false
            } else if (a.operator === '>=' && !n(a.semver, String(e), t))
              return false
          }
          if (l) {
            if (e.operator === '<' || e.operator === '<=') {
              E = lowerLT(l, e, t)
              if (E === e) return false
            } else if (l.operator === '<=' && !n(l.semver, String(e), t))
              return false
          }
