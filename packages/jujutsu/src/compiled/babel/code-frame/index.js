;(() => {
  var e = {
    ...
    287: (e) => {
      'use strict'
      e.exports = require('jujutsu/dist/compiled/chalk')
    },
    970: (e, t) => {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: true })
    ...
    537: (e, t, r) => {
      ...
      let c
      {
        ...
        const getTokenType = function (t, r, n) {
          ...
          if (t.type === 'punctuator' && a.test(t.value)) {
            return 'bracket'
          }
      ...
      function highlightTokens(e, t) {
        let r = ''
        for (const { type: n, value: i } of c(t)) {
          const t = e[n]
          if (t) {
            r += i
              .split(u)
      ...
      function getChalk(e) {
        return e.forceColor ? new s.constructor({ enabled: true, level: 1 }) : s
      }
  ...
  ;(() => {
    ...
    e.codeFrameColumns = codeFrameColumns
    e['default'] = _default
    var t = _interopRequireWildcard(__nccwpck_require__(537))
    ...
    function getMarkerLines(e, t, r) {
      ...
      return { start: d, end: f, markerLines: p }
    }
    function codeFrameColumns(e, r, n = {}) {
      const s = (n.highlightCode || n.forceColor) && (0, t.shouldHighlight)(n)
      const o = (0, t.getChalk)(n)
      const u = getDefs(o)
      const maybeHighlight = (e, t) => (s ? e(t) : t)
      const a = e.split(i)
      const { start: c, end: l, markerLines: d } = getMarkerLines(r, a, n)
      const f = r.start && typeof r.start.column === 'number'
      const g = String(l).length
      const p = s ? (0, t.default)(e, n) : e
      let h = p
        .split(i)
        .slice(c, l)
        .map((e, t) => {
          ...
          if (o) {
            ...
            if (Array.isArray(o)) {
              ...
              t = [
                '\n ',
                maybeHighlight(u.gutter, s.replace(/\d/g, ' ')),
                r,
                maybeHighlight(u.marker, '^').repeat(i),
              ].join('')
              if (a && n.message) {
                t += ' ' + maybeHighlight(u.message, n.message)
              }
            }
            return [
              maybeHighlight(u.marker, '>'),
              maybeHighlight(u.gutter, s),
              e,
              t,
            ].join('')
          } else {
            return ` ${maybeHighlight(u.gutter, s)}${e}`
          }
        })
        .join('\n')
      if (n.message && !f) {
        h = `${' '.repeat(g + 1)}${n.message}\n${h}`
      }
      if (s) {
        return o.reset(h)
      } else {
    ...
    function _default(e, t, r, i = {}) {
      ...
      r = Math.max(r, 0)
      const s = { start: { column: r, line: t } }
      return codeFrameColumns(e, s, i)
    }
  })()
  module.exports = r
})()
