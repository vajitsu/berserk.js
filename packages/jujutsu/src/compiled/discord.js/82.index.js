...
exports.ids = [82]
exports.modules = {
  /***/ 8783: /***/ (__unused_webpack_module, exports) => {
  ...
  /***/ 8633: /***/ (
    ...
    var external_node_fs_ = __webpack_require__(7561) // CONCATENATED MODULE: ../../node_modules/.pnpm/strtok3@7.0.0/node_modules/strtok3/lib/FsPromise.js
    /**
    ...
    var external_node_buffer_ = __webpack_require__(2254) // CONCATENATED MODULE: ../../node_modules/.pnpm/strtok3@7.0.0/node_modules/strtok3/lib/AbstractTokenizer.js
    /**
     * Core tokenizer
     */
        ...
        if (normOptions.length > 0) {
          try {
            ...
            if (
              options &&
              options.mayBeLess &&
              err instanceof EndOfStreamError
            ) {
              return 0
            }
            throw err
    ...
    var ieee754 = __webpack_require__(8783) // CONCATENATED MODULE: ../../node_modules/.pnpm/token-types@5.0.1/node_modules/token-types/lib/index.js
    // Primitive types
    function dv(array) {
    ...
    const Float16_BE = {
      ...
      get(dataView, offset) {
        return ieee754 /* read */
          .i(dataView, offset, false, 10, this.len)
      },
      put(dataView, offset, value) {
        ieee754 /* write */
          .c(dataView, value, offset, false, 10, this.len)
    ...
    const Float16_LE = {
      ...
      get(array, offset) {
        return ieee754 /* read */
          .i(array, offset, true, 10, this.len)
      },
      put(array, offset, value) {
        ieee754 /* write */
          .c(array, value, offset, true, 10, this.len)
        return offset + this.len
      },
    }
    /**
    ...
    const Float80_BE = {
      ...
      get(array, offset) {
        return ieee754 /* read */
          .i(array, offset, false, 63, this.len)
      },
      put(array, offset, value) {
        ieee754 /* write */
          .c(array, value, offset, false, 63, this.len)
        return offset + this.len
      },
    }
    /**
    ...
    const Float80_LE = {
      ...
      get(array, offset) {
        return ieee754 /* read */
          .i(array, offset, true, 63, this.len)
      },
      put(array, offset, value) {
        ieee754 /* write */
          .c(array, value, offset, true, 63, this.len)
        return offset + this.len
      },
    }
    /**
    ...
    class StringType {
      ...
      get(uint8Array, offset) {
        return external_node_buffer_.Buffer.from(uint8Array).toString(
          this.encoding,
          offset,
          offset + this.len
        )
    ...
    ] // CONCATENATED MODULE: ../../node_modules/.pnpm/file-type@18.0.0/node_modules/file-type/util.js
...
*/
    const uint32SyncSafeToken = {
      get: (buffer, offset) =>
        ...
        (buffer[offset] << 21),
      len: 4,
    } // CONCATENATED MODULE: ../../node_modules/.pnpm/file-type@18.0.0/node_modules/file-type/supported.js
    ...
    const supported_mimeTypes = [
      ...
      'image/jxl',
      'application/zstd',
    ] // CONCATENATED MODULE: ../../node_modules/.pnpm/file-type@18.0.0/node_modules/file-type/core.js
    ...
    class FileTypeParser {
      ...
      async parse(tokenizer) {
        ...
        if (this.checkString('%PDF')) {
          ...
          const buffer = external_node_buffer_.Buffer.alloc(
          ...
          if (
            buffer.includes(external_node_buffer_.Buffer.from('AIPrivateData'))
          ) {
            return {
              ext: 'ai',
              mime: 'application/postscript',
        ...
        if (
          this.check([0x49, 0x49, 0x52, 0x4f, 0x08, 0x00, 0x00, 0x00, 0x18])
        ) {
          return {
            ext: 'orf',
        ...
        if (this.check([0xfe, 0xff])) {
          // UTF-16-BOM-LE
          if (
            this.check([0, 60, 0, 63, 0, 120, 0, 109, 0, 108], { offset: 2 })
          ) {
            return {
              ext: 'xml',
              mime: 'application/xml',
      ...
      async readTiffHeader(bigEndian) {
        ...
        const ifdOffset = (bigEndian ? UINT32_BE : UINT32_LE).get(
          this.buffer,
          4
        )
    ...
    async function fileTypeStream(
      readableStream,
      { sampleSize = minimumBytes } = {}
    ) {
      const { default: stream } = await Promise.resolve(/* import() */).then(
        __webpack_require__.t.bind(__webpack_require__, 4492, 19)
      )
          ...
          ;(async () => {
            try {
              ...
              const chunk =
                ...
                readableStream.read() ??
                external_node_buffer_.Buffer.alloc(0)
              try {
    ...
    const supportedMimeTypes = new Set(supported_mimeTypes) // CONCATENATED MODULE: ../../node_modules/.pnpm/file-type@18.0.0/node_modules/file-type/index.js
