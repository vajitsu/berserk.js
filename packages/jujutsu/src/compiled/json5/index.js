  ...
  var u = {
    ...
    866: (u, D, e) => {
      ...
      function newToken(u, D) {
        return { type: u, value: D, line: n, column: a }
      }
      function literal(u) {
        for (const D of u) {
          const u = peek()
      ...
      function invalidChar(u) {
        ...
        return syntaxError(
          `JSON5: invalid character '${formatChar(u)}' at ${n}:${a}`
        )
      }
      function invalidEOF() {
        return syntaxError(`JSON5: invalid end of input at ${n}:${a}`)
