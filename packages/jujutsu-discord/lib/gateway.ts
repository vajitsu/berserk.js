...
import WebSocket from '@jujutsu/discord/dist/compiled/ws'
import lodash from '@jujutsu/discord/dist/compiled/lodash'
...
export async function send_identify<T extends identify_params>(
  ...
  let payload: identify_payload | Buffer | string = {
    ...
    d: {
      ...
      properties: {
        os: platform(),
        browser: 'jujutsu_discord',
        device: 'jujutsu_discord',
      },
    },
  }
